...
| *Usage* | "toolbox.exe" -cue2pops "input_file" "output_file" |
|  | OR "toolbox.exe" -cue2pops "input_file" |
| *Example* | "K:\toolbox\AMERICAN_POOL.cue" "L:\POPS\AMERICAN_POOL.VCD" |
|  | OR "K:\toolbox\AMERICAN_POOL.cue"  |
| *Notes* | input_file must be an ASCII cuesheet (CUE) which points to a Mode 2 Form 1 CD-ROM image. |
