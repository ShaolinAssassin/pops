...
* A software that allows you to transfer the converted disc images to your PS2 HDD (such as "PFSshell":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/pfsshell, or "uLaunchELF":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/apps-last-version and "RadHostClient":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/radhostclient...)
...
* *Note :* +__.POPS is not correct. Use AKuHAK's uLaunchELF build or "uLE_kHn build":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/apps-last-version to create a partition without +.
...
POPStarter bundle comes with a POPSTARTER.KELF (Krypo-ELF = ELF embedded into a container). It can be used if you have the Browser 2.00 (aka HDDOSD) installed on your HDD. Otherwise, it's useless. Use "AKuHAK's hdl_dumx":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/related-stuff to install it.
