...
2. Create a partition named "__.POPS" in your PS2 HDD, large enough so you can put all your VCDs inside. Note : "+__.POPS" is not correct. Use "AKuHAK's uLaunchELF build":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/related-stuff or "uLE_kHn build":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/apps-last-version to create a partition without "+".
