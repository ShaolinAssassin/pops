...
| *Notes* | The partition names are case sensitive, and have to match the POPStarter ELF names. |
| *Notes* | Whitespaces are not allowed in the partition names. |
| *Notes* | The file extension .VCD has to be uppercase. |
