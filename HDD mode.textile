...
---- Old launch type (HDDOSD compatible)
- Prefix for POPStarter.ELF : PP. (PP(dot))  -    (if used)
- Prefix for partition name : PP. (PP(dot))
- Game name : IMAGE0.VCD (all uppercase)
- Description : This is a launch type that was used in POPStarter 12 and older versions. It allows you to install one VCD per partition. The VCD has to be named "IMAGE0.VCD" (all uppercase).
...
- Note : The partition is shown in the HDDOSD / PSBBN / PSX XMB.
