...
* The file name "IMAGE0.VCD" has to be uppercase (_old launch type setup_).
* The partition names are case sensitive, and have to match the POPStarter ELF names (old launch type setup_).
* Whitespaces are not allowed in the partition names (old launch type  setup_).
