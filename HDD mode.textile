...
POPStarter bundle comes with a POPSTARTER.KELF (Krypo-elf,ELF embedded into a container). It can be used of you have the Browser 2.00 aka HDDOSD installed on your HDD. Otherwise, it's useless. Use AkuHak's hdl_dumx to install it.
