...
Notes : These protos are meant to test some new features. They are *NOT* meant to be used as daily gaming version. They refuse to run from OPL, *by design*. More infos "here":http://www.psx-place.com/threads/open-ps2-loader-v0-9-3.13415/page-4#post-84429. 


* *"POPStarter Revision 13, WIP 06, OBT 17+, Proto 20171008":https://www.metagames-eu.com/forums/playstation-2/popstarter-revision-13-sorties-et-developpements-36-134569.html#post1776249*

pre. 
- Fixed a codecache memory leak, which filled up the memory with iterated calls to the exception handler


* *"POPStarter Revision 13, WIP 06, OBT 17+, Proto 20171003":https://www.metagames-eu.com/forums/playstation-2/popstarter-revision-13-sorties-et-developpements-33-134569.html#post1776217*
...
- Workaround to POPS not handling CDDA tracks pregaps/pauses, specifically for Tomb Raider, Tomb Raider II and Ninja. One 
remaining messup on TR2 though : cutscenes (not FMVs) aren't synced with the audio, and the gap between audio/video gets 
worse as the cutscene is runnin, due to animation slowdowns. TR1 looked fine when I tried it. Ninja audio should start ~2
seconds too early or too late, because of non-existent pregaps.
- Did something for the PAL releases of Team Buddies but can't remember what. Perhaps that has something to do with the PAL
patcher issue that was reported over at ElOtroLado...
- Proper LibCrypt key injection for NFS: Porsche 2000. Both the UK and the other release have the same volume descriptor, 
but different keys. POPStarter wrongly used the same key for the two versions, because of the VCD identifier design. I got 
that problem solved with a little trick. Now the race should stop resetting every 12 seconds (the actual LC protection), 
since the magic word is valid.
...
* *"POPStarter Revision 13, WIP 06, OBT 17+, Proto 20170703":https://www.metagames-eu.com/forums/playstation-2/popstarter-revision-13-sorties-et-developpements-33-134569.html#post1775856*

pre. 
- Encore quelques bugs de patchés sur POPS. Susceptibles d’accroitre la compatibilité.
- Réécriture des modes de compatibilité. Je me suis rendu compte que le mode 0x05 avait un problème, en laissant Colony 
Wars tourner une quarantaine de minutes, l'intro (FMV) plantait. Alors j'ai tout recodé proprement.
...
- Tentative de résolution du crash de Rayman 2 : semble fonctionner sur la version FR/DE, j'ai des doutes concernant la 
version EN/IT/ES, et ne fonctionne pas sur la version NTSC U/C.
- Suppression des fixes intégrés à POPStarter pour Metal Gear Solid. Ils servaient à contourner les cutscenes qui faisaient 
crasher POPS. Je pense que le bug de POPS a été corrigé et que nous n'en avons plus besoin...
...
* *"POPStarter Revision 13, WIP 06, OBT 17+, Proto 20170624":https://www.metagames-eu.com/forums/playstation-2/popstarter-revision-13-sorties-et-developpements-32-134569.html#post1775817*
...
* *"POPStarter Revision 13, WIP 06, OBT 17+, Proto 20170615":https://www.metagames-eu.com/forums/playstation-2/popstarter-revision-13-sorties-et-developpements-31-134569.html#post1775789*
...
* *"POPStarter Revision 13, WIP 06, OBT 17+, Proto 20170531":https://www.metagames-eu.com/forums/playstation-2/popstarter-revision-13-sorties-et-developpements-30-134569.html#post1775752*
...
* *"POPStarter Revision 13, WIP 06, OBT 17+, Proto 20170530":https://www.metagames-eu.com/forums/playstation-2/popstarter-revision-13-sorties-et-developpements-30-134569.html#post1775741*
...
* *"POPStarter Revision 13, WIP 06, OBT 17+, Proto 20170527":https://www.metagames-eu.com/forums/playstation-2/popstarter-revision-13-sorties-et-developpements-30-134569.html#post1775718*
