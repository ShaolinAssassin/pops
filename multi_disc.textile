...
* Open the lid : !https://bitbucket.org/repo/Mpy7Eg/images/3405191067-Playstation-Button-Select.png(title)! + !https://bitbucket.org/repo/Mpy7Eg/images/1165364186-Playstation-Button-L2.png(title)! +
!https://bitbucket.org/repo/Mpy7Eg/images/1712503932-Playstation-Button-R2.png(title)! +
!https://bitbucket.org/repo/Mpy7Eg/images/2651471562-Playstation-Button-T.png(title)!
...
*Note :* keep in mind that the change disc feature is useful only if you must swap discs *without any PS1 reboot*. Game like Grandia asks you to reboot to be able to load disc 2. In this situation, you only need to swap the VMCs manually (copy/paste VMCs from VMC disc 1 folder to VMC disc 2 folder) - or you can use the "trick" below to avoid such a manipulation.
...
You can use the VMCDIR.TXT file to use only 1 pair of VMCs for a multi-disc game. This VMCDIR.TXT must be placed into the disc 1 VMC folder. Read "here":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/VMC to know more about the VMCDIR.TXT file ("Setting a path for the VMC folder" section).
