...
h2. _Use a single pair of VMC for multi-disc games :_

You can use the VMCDIR.TXT file to use only 1 pair of VMCs for this multi-disc game.
...
You could even disable the need of the 2nd VMC, by editing "POPStarter configuration table":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/POPStarter%20Configuration%20Table
