...
If your game is poorly emulated, you can try to enable a "compatibility mode":https://bitbucket.org/SaulGoodman/popstarter-documentation-stuff/downloads/Compatibility%20Modes.zip to see if it helps.
...
In the "Game Fixes Archive":https://bitbucket.org/SaulGoodman/popstarter-documentation-stuff/downloads/IGR%20Behaviour%20Modifiers.zip, you can find some TROJAN files fixing problematic games. Copy the file in the VMC directory of your problematic game; then run the game. 
