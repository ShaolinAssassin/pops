...
| $SET_TIMINGS | Tech stuff... | Read changes introduced in Prototype 5 in the "changelog": https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/popstarter-changelog. |
| $LOAD_TIMINGS | Tech stuff... | Read changes introduced in Prototype 5 in the "changelog": https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/popstarter-changelog. |
