...
| $XPOS_#### | Centers the screen horizontally. | # is a number (decimal). Works only in PAL and NTSC modes. Default value : 640. Decrease it to move the screen on the left, increase for the right. |
| $YPOS_## | Centers the screen vertically. | # is a number (decimal). Works only in PAL and NTSC modes. Not working in OBT15, fixed in OBT16. |
