...
| "$D2LS":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/D2LS  | "Left Stick is the D-Pad" code.  | Stay on Digital Mode version. Enables joystick support for games that doesn't support it natively. |
| $D2LS_ALT | "Left Stick is the D-Pad" code.  | Minus Stay on Digital Mode version. Enables joystick support for games that doesn't support it natively. |
