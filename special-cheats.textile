...
| $CODECACHE_ADDON_0 | For games that lag badly or stall randomly. | Do not use it by default on all your games, because most games will stop working with it. |
...
| $"WIDESCREEN":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/ps1-widescreen-codes | Enables POPS GTE widescreen hack and forces 16:9. | Does not deal with stuff like HUDs, texts/fonts, menus, 2D backgrounds... This hack is not finished (no render fix...). |
