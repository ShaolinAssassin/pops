h1. [HDD] *Transfer VCD files over network using RadHostClient*
...
* "RadHostClient":http://sksapps.com/media/RadHostClient.zip
* "uLE (any version)":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/downloads/uLE_kHn_20150727.zip
