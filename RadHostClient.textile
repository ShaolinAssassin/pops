...
3. [PC] Launch RadHostClient (admin mode ?) and set the PS2 IP adress. Once your PS2 is detected over network, you will see "Connected" at the bottom of RadHostClient program;
