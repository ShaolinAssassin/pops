...
To use POPStarter in SMB mode, you have to find and download the compressed POPS file. This file is named "POPS_IOX.PAK" and it's the same as the USB mode uses... 
