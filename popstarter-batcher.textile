...
_Note : 11/26/2016 - compatibility fix for WinXP (thanks to El_Patas for the report)._
...
*1.* Drop BATCHER_0.3.1.EXE where your .VCD are (recommended : either from CUE2POPS folder, or from your POPS folder) ;
