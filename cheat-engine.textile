...
To convert a PS1 code to PS2 RAW format,  add $01000000 to the adresses and comply with the code type definitions of the target PS2 cheat engine. For more info, check this "post":http://assemblergames.com/l/threads/ps2-pops-stuff.45347/page-27#post-760915.
