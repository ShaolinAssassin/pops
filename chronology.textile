...
| Unknown date | A secret project is elaborated by never-named PS2 developers. A GUI was planned. It would have had options to select VMC, BIOS..., USB support (keep in mind that POPS was at start for HDD users only),  a cheat engline, a fully working IGR... |
