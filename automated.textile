...
If a POPStarter build-in LibCrypt crack crashes the emulation, prevents you from playing the game or does not work, disable it by patching the POPStarter KELF/ELF with NO_LC_CRACKS.PPF, then patch your disc image with a good old PS1 scene crack (you may find some of them in the Compatibility List which is maintained by El_Patas for Elotrolado, or at "ConsoleCopyWorld":http://consolecopyworld.com/psx/psx_patches.shtml).
...
h2. _New fixes integrated into POPStarter Revision 13 since WIP 05_
_[According to POPStarter changelogs]_
...
h2. _POPStarter Revision 13, Build Date : 2015/06/03, *WIP 05* PUBLIC RELEASE_
