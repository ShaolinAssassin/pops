...
* Only exception to this rule is when 2 CHEATS.TXT files are loaded from POPS and VMC game folder and that CHEATS.TXT file contains special cheats changing the video mode.
