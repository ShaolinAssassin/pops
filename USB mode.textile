...
* Mass folders mass:/POPS/, mass:/POPS0/, mass:/POPS1/... to mass:/POPS9/ can received your VCDs (and will be read in this order). The usual files for the POPS folder (POPS_IOP.PAK & the TM2s) must remain in the main POPS folder.
* BIOS.BIN, PATCH_#.BIN, TROJAN_#.BIN or VMCDIR.TXT must be in your /POPS#/ folder to be used by POPStarter.
