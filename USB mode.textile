...
* HDD supports 1 launch type - the "new" one : 
...
| *Example* | With the POPStarter ELF renamed as Some Game.elf, POPStarter will launch Some Game.VCD which is in the POPStarter folder named /POPS/ or /POPS0/ or /POPS1/ up to /POPS9/ |
...
* Mass folders mass:/POPS/, mass:/POPS0/, mass:/POPS1/... to mass:/POPS9/ can receive your VCDs (and will be read in this order). The usual files for the POPS folder (POPS_IOP.PAK & the TM2s) must remain in the main POPS folder.
...
* You can use your own USB modules (usbd.irx & usbhdfsd.irx, case sensitive, no file size restriction) from mc#:/POPSTARTER/ (When a file can't be found in mc0:/POPSTARTER/, POPStarter tries to load it from mc1:/POPSTARTER/...). Mass is not supported anymore.
______________________________________________________________________________________________________________
