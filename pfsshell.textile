...
* "PFSSHELL 0.2a":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/related-stuff (running under winxp - or enable XP compatibility mode)
...
_[Original tutorial by ElPatas]_ "@elotrolado":http://www.elotrolado.net/hilo_ho-pops-emulador-de-psx-para-ps2_1874054 -  _[.bats thanks to "deba5er":http://psx-scene.com/forums/members/deba5er/ ]_

1. Get "pfs.bat":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/downloads/pfs-scripts.7z files and place it in pfsshell folder. 
