...
*Note :* 
* If your .CUE is missing, you can download an archive (bunch of PS1 .CUEs) from "here":http://redump.org/cues/psx/ (do not forget that name of .BIN & .CUE must match. Ex : Driver.bin & Driver.cue. Rename your .BIN, as maybe the .CUE you downloaded has info inside about CD tracks). 
