...
To convert your PS1 games from .BIN+.CUE to .VCD, you need to use the last version of "CUE2POPS":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/apps_last.
...
* To multi-disc games, please read this section about how to use the "multi-dic support feature":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/multi_disc.
