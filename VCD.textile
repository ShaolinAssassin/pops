...
To convert your PS1 games from .BIN+.CUE to .VCD, you need to use the last version of "CUE2POPS": https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/downloads
...
* CUE2POPS is a part of Toolbox soft, which can do more than only convert your games to .VCD. For a complete description, see "here":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/Toolbox%20commands
