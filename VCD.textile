...
* Toolbox can do more than only convert your games to .VCD. For a complete description, see "here"::https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/Toolbox%20commands.
