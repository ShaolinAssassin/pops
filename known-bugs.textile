...
* *"PS1 CD mode :":https://assemblergames.com/threads/ps2-pops-stuff-popstarter.45347/page-112#post-952852* we found out after RIP 06 release that the HDD old launch type method (PP.GAME.ELF or PP.PS1CD.ELF) has a bug : files from __common/POPS folder (and from __common/POPS/GAME) will not be loaded.
