...
* It can be used as a GUI launch your VCDs directly. Just place a single copy of POPSTARTER.ELF in your POPS folder and you're done (no need to rename it). 

*Ex ample of working setup - USB mode :*
