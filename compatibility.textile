...
*Note :* if your game lags badly or stalls randomly, you can try to use "$CODECACHE_ADDON_0 command":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/edit/special-cheats in a GAME/CHEATS.TXT file. Do not use it by default on all your games, because most games will stop working with it.
