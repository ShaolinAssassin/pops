...
*Note :* if your game lags badly or stalls randomly, you can try to use $CODECACHE_ADDON_0 command in a GAME/CHEATS.TXT file. Do not use it by default on all your games, because most games will stop working with it.
