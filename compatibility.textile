...
3 options : 
# Using a PATCH_X.BIN file from the "compatibility mode archive":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/downloads/Compatibility_Modes.zip;
...
*Using a PATCH_X.BIN file* : get the "compatibility mode archive":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/downloads/Compatibility_Modes.zip, copy the PATCH file in the VMC directory of your problematic game then test the game;
