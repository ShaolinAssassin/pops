...
3 options : 
# Using a PATCH_X.BIN file from the compatibility mode archive;
# Using a CHEATS.TXT file;
# Hardcoding the mode in POPStarter (advanced).

*Using a PATCH_X.BIN file* : get the "compatibility mode archive":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/downloads/Compatibility_Modes.7z, copy the PATCH file in the VMC directory of your problematic game then test the game. If the compatibility mode doesn't solve any problem in your game, delete the PATCH file from the VMC directory and redo the operations with the next PATCH file.

*Using CHEATS.TXT file* : see the "cheat engine":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/cheat-engine section to know how to enable a mode using the cheat engine.

*Hardcoding the mode in POPStarter : see "POPStarter configuration table":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/configuration-table.
