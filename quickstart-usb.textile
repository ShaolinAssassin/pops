...
Quickstarter pack includes *POPStarter last STABLE version [Rev 13 - WIP5]* - recommended version for new POPStarter usersand recommended as daily gaming version. Once you consider yourself comfortable enough with this version, you can upgrade to the last beta and enjoy/experiment the last features - or wait for the next stable version - it's up to you.
