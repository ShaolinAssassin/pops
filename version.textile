...
Open POPSTARTER.ELF file with a hex editor and look at offset $59 (blue) on pic below : it's the *Build date*. In red, starting at offset $5E is the *Build ID*. With these two informations, you can determine what version you are currently using (see table below).
