...
POPStarter has his own IGR (Select+R1+L1). You can change the button combo using one PATCH/TROJAN ("IGR Behaviour Modifiers archive":https://bitbucket.org/SaulGoodman/popstarter-documentation-stuff/downloads/IGR%20Behaviour%20Modifiers.zip).
