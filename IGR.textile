...
POPStarter has his own IGR (Select+R1+L1). You can change the button combo using one PATCH/TROJAN.
...
Some piece of info from  about how to make you own IGR textures :
