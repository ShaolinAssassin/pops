...
| *$42F* | *POPStarter automatic compatibility mode activator* | *0x00 = Do not enable anything *| *Notes* |
|   |   | *0x01 = Enable the automatic compatibility modes activation* |   |
|   |   | *0x02 = Enable the other subroutines (like LibCrypt cracks, when available)* |   |
|   |   | *0x03 = Enable all* |   |
...
| *Offset* | *Description* | *Values* | *Notes* |
| *$42F* | POPStarter automatic compatibility mode activator | 0x00 = Do not enable anything |   |
|   |   | 0x01 = Enable the automatic compatibility modes activation |   |
|   |   | 0x02 = Enable the other subroutines (like LibCrypt cracks, when available) |   |
|   |   | 0x03 = Enable all |   |
