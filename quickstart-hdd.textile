...
*6.* Rename POPStarter.ELF to Name of your game.ELF (example : Crash Bandicoot.elf) and copy/paste it into __.POPS partition.. The names of your ELF and the name of your VCD must be the same - it's case sensitive. 
