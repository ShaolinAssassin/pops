...
Contrary to what had been said, POPS-00001 isn't the emulator itself, it's a loader which has POPS inside. The "famous" 3,3MB EXECUTE.ELF was made of a homebrew launcher + the POPS ELF + the POPS IOPRP.
