...
*Example :* Colin McRae Rally 2.0 (SLUS-01222) 

CHEATS.TXT : 

pre. 
Widescreen hack by VIRGIN KLM (Gameshark/Action Replay codes) & Paul_met (Hexadecimal codes)
$SAFEMODE
...
* *Note :* these codes can be converted into HEX codes, applied to game images and used on a PlayStation 1 retail console with no problem (as reported by some users). 
