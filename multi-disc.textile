...
* If you have more than 5 lines in the DISCS.TXT file, the feature will not work.
...
DISCS_POOPER is a little program that does the boring writing text files for you. 

1. Create a new folder ;
2. Drop the VCD files of your multic-disc game ;
3. Run DISCS_POOPER.EXE

DISCS_POOPER creates : 
. VMC folder for each VCD in the folder ;
. DISCS.TXT inside each VMC folder ;
. VMCDIR.TXT inside each VMC to use only a pair of VMC for this multi-disc game.

Limits : 
. Doesn't comply with 4 CDs limit of the swap disc feature ;
