...
If you didn't, POPS will use the built-in BIOS. You can also put it in the POPS folder, so it will be used for all games.
This doesn't improve compatibility tho. 
