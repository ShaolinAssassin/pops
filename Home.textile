...
* *LATEST STABLE VERSION BUNDLE :* "POPStarter Revision 13, WIP 05 (2015/06/03)":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/downloads/POPStarter_r13_WIP_05.7z
* *LATEST BETA VERSION BUNDLE :* "POPStarter Revision 13, WIP 06, OBT 15 (2016/09/18)":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/downloads/POPStarter_r13_WIP_06_OBT_20160723_OBT15.7z
...
These guides use last POPStarter *STABLE* version [Rev 13, WIP 05] - so there is not quickstart guide for SMB (until the next stable version).

* *"Quickstart guide for internal HDD":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/quickstart-hdd*

* *"Quickstart guide for USB device":https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/quickstart-usb*
