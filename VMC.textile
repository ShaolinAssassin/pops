...
When you launch a game for the very first time, a new folder named "NameofyourVCD" will be created into your POPS directory. It has 2 files, which are you VMC. If you know how to hexedit POPStarter, you can change it to have only 1 VMC created - or not at all. Check the "configuration table":https://bitbucket.org/SaulGoodman/popstarter-documentation-stuff/wiki/POPStarter%20Configuration%20Table to know how to change the default setting (offset $429).
